...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.wle = nn.Embedding(config.vocab_size, self.embed_dim)
    ...
    def parallelize(self, device_map=None):
        ...
        self.wle = self.wle.to(self.first_device)
        # Load onto devices
    ...
    def forward(
        ...
        if language_ids is not None:
            language_ids = language_ids.view(-1, input_shape[-1])
        ...
        language_embeds = self.wle(language_ids)
        hidden_states = inputs_embeds + position_embeds + language_embeds
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, past=None, **kwargs):
        ...
        language_ids = kwargs.get('language_ids', None)
